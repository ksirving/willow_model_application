...
write.csv(limits, "output_data/W4_F300_willow_adult_stream_power_Q_limits.csv")
...
time_stats
write.csv(time_stats, "output_data/W4_F300_time_stats_willow_adult_stream_power.csv")
...
write.csv(total_days_per_year01, "output_data/W4_F300_number_of_days_willow_adult_stream_power.csv")
...
write.csv(limits, "output_data/W4_F300_willow_germ_depth_Q_limits.csv")
### percent

## plot with thresholds
labels <- c(depth_cm_LOB = "Left Over Bank", depth_cm_MC = "Main Channel", depth_cm_ROB = "Right Over Bank")

png("figures/Application_curves/Depth/F300_willow_germ_Depth_Q.png", width = 500, height = 600)
...
head(melt_time)
write.csv(melt_time, "output_data/W4_F300_willow_germ_depth_time_stats.csv")
...
write.csv(total_days, "output_data/W4_F300_willow_germ_depth_total_days.csv")
write.csv(total_days_year, "output_data/W4_F300_willow_germ_depth_total_days_year.csv")
...
## save df
write.csv(melt_days, "output_data/W4_F300_willow_germ_depth_total_days_long.csv")
