...
save(new_data, file="output_data/W1_F57C_seedling_inundation_discharge_probability_time_series_red_columns.RData")
...
save(new_data, file="output_data/W1_F57C_seedling_inundation_discharge_probs_2010_2017_TS.RData")

# probability as a function of discharge -----------------------------------


load( file="output_data/W1_F57C_seedling_inundation_discharge_probs_2010_2017_TS.RData")
head(new_data)
...
write.csv(limits, "output_data/W1_seedling_depth_F57C_Q_limits.csv")

# plot discharge points ---------------------------------------------------
labels <- c(depth_cm_LOB = "Left Over Bank", depth_cm_MC = "Main Channel", depth_cm_ROB = "Right Over Bank")

png("Figures/Application_curves/Depth/F57C_willow_seedling_depth_prob_Q_thresholds.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/W1_willow_F57C_seedling_depth_time_stats.csv")

## plot for annual stats - need probs in order

png("Figures/Application_curves/Depth/F57C_seedling_depth_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/F57C_seedling_depth_perc_time_above_threshold_non_critical.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/F57C_seedling_depth_perc_time_above_threshold_critical.png", width = 500, height = 600)
...
write.csv(total_days, "output_data/W1_F57C_willow_seedling_depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/W1_F57C_willow_seedling_total_days_long.csv")

library(scales)

## plot all ts

png("Figures/Application_curves/Depth/F57C_seedling_depth_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/F57C_seedling_depth_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/F57C_seedling_depth_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
